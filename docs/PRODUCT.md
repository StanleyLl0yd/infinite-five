...
15. Shared authoritative Rust rules/AI core and trust-boundary hardening. Completed in v0.6.1.
16. Extreme-coordinate validation and raster launcher-icon hardening. Completed across v0.6.2-v0.6.3.
